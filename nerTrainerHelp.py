...
sentence = "I was wondering who plays Peter Parker in Spider-Man: Far From Home?"

# Step 2: put the EXACT spelling of the PERSON, MOVIE, ORGANIZATION from your sentence below
person = "Peter Parker" # Put the person name here
pLen = len(person)
pFirst = sentence.find(person)
pLast = pFirst + pLen

movie = "Spider-Man: Far From Home" # Put the movie name here
mLen = len(movie)
